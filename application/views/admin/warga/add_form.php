...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        ...
        <form action="<?= base_url('admin/warga/add') ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nik" name="nik" onkeyup="cekPhone(this)" maxlength="16">
            </div>
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="daging_qurban" name="daging_qurban">
                    ...
                    <?php foreach ($meats as $key => $meat) { ?>
                        <option value="<?= $meat->id_daging ?>"><?= $meat->nama_hewan ?></option>
                    <?php } ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-check">
                    <input class="form-check-input" type="radio" name="gender" id="gender1" value="laki_laki" checked>
